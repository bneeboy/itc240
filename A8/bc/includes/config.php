...
$config->nav1['db_list.php'] = 'Kittens';
$config->nav1['contact1.php'] = 'Contact Us';
$config->nav1['template.php'] = 'Template';


//These are defaults
$config->slogan= 'Business Casual - The Whizz';
...
switch (THIS_PAGE)
{
    ...
    case 'contact1.php':
        ...
        $config->slogan= 'Contact the Whizz!';
    break;
        
    case 'db_list.php':
        $config->title='Kittens';
    break;
...
function myerror($myFile, $myLine, $errorMsg)
{
    if(defined('DEBUG') && DEBUG)
    {
       ...
       die();
		...
		echo "I'm sorry, we have encountered an error.  Would you like to see some memes?";
		die();
    }
}
