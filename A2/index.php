...
//$myDay = 'Monday';//USE FOR TESTING ONLY
...
switch($myDay)
{
    case 'Monday':
          ...
          $color = 'Cosmic Latte';
          $image = 'mocha.jpg';
          $alt = 'This is a picture of a Mocha';
          $desc = 'which is year round, a real treat!';
    break;
    ...
    case 'Tuesday':
          ...
          $color = 'Latte';
          $image = 'latte.jpg';
          $alt = 'This is a picture of a latte';
    ...
    case 'Thursday':
          ...
          $alt = 'This is a picture of a pumpkin spice latte';
          $desc = 'which makes us wish it was always Fall, as this is one of our top sellers!';
     break;
}
...
<head>
    ...
    <style type="text/css">
        ...
        .feature {color:<?=$color?>; /* daily feature color - pumpkin! */}
...
<body>
    ...
    <main>
        ...
        <p>
    		 <img src="images/<?=$image?>" alt="Our Pumpkin Spice Latte tastes great on a Fall Day!" id="coffee" />
            <strong class="feature"><?=$myDay?>'s Coffee Special:</strong> <?=$myDay?>'s daily coffee special is <strong class="feature"><?=$coffee?></strong>, <?=$desc?></p>
